<div align="center">
  <img
    src="https://capsule-render.vercel.app/api?type=venom&height=220&text=JO%C3%83O%20VITOR%20MINTZ&fontSize=42&fontColor=f5f3ff&stroke=0&section=header&animation=fadeIn&desc=COMPUTER%20SCIENCE%20%7C%20CI%C3%8ANCIA%20DA%20COMPUTA%C3%87%C3%83O&descAlignY=68&descSize=18&descAlign=50&color=4c2b78"
    width="100%"
...
I am **João Vitor Garcia Aguiar Mintz**, a **Computer Science** student at **Mackenzie Presbyterian University**.

I worked on the [**Intêrpret**](https://computacao.mackenzie.br/mackleaps/projetos/interpret/) project at **MackLEAPS**, focusing on **BFF (Backend for Frontend)**, security practices, and clean development standards.

I was also an intern at **Huawei Brazil** in **ICT Consulting & System Integration**, developing **Python** scripts for process automation, data analysis, and efficiency improvements through algorithms and parallelization.
...
- Game development and prototyping with **Unity**.
- Studies in **cybersecurity**, vulnerability testing, and analysis tools.
- Interest in **software architecture**, networking, and performance optimization.
...
```text
Game Development      • Unity • Mechanics • Performance
Cybersecurity         • Vulnerability Analysis • APIs • Networking
Software Architecture • Design Patterns • Organization • Scalability
Parallel Computing    • Efficiency • Algorithms • Optimization
```
